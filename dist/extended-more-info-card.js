              ...
              <ha-button-menu slot="actionItems" corner="BOTTOM_START">
                ...
                ${d?B`
                      <ha-list-item graphic="icon" @click=${()=>this._showView("device_info")}>
                        <ha-svg-icon slot="graphic" .path=${"M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z"}></ha-svg-icon>
                        Device info
                      </ha-list-item>
                    `:""}
                ${c?B`
                      <ha-list-item graphic="icon" @click=${()=>this._showView("related")}>
                        <ha-svg-icon slot="graphic" .path=${"M2,11H9.17C9.58,9.83 10.69,9 12,9C13.31,9 14.42,9.83 14.83,11H22V13H14.83C14.42,14.17 13.31,15 12,15C10.69,15 9.58,14.17 9.17,13H2V11Z"}></ha-svg-icon>
                        Related
                      </ha-list-item>
                    `:""}
              </ha-button-menu>
